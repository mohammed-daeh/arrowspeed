...
class BoxRecentSearchesController extends GetxController {
...
class BoxRecentSearches extends StatelessWidget {
  const BoxRecentSearches({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BoxRecentSearchesController>(
      init: BoxRecentSearchesController(),
      builder: (controller) {
        return Column(
          ...
          children: [
            Padding(
              ...
              child: Text(Utils.localize('RecentSearches'),
...
class CardRecentSearches extends StatelessWidget {
